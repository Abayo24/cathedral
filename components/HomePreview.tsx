						...
						({
							...
							>
								...
								<div className='relative h-48 overflow-hidden rounded-t-3xl'>
									...
									{/* Icon badge */}
									<div
										className={`absolute top-4 right-4 w-10 h-10 rounded-full flex items-center justify-center shadow-md ${accent === 'crimson' ? 'bg-crimson' : 'bg-royal'}`}
									>
										<Icon
											size={17}
								...
								<div className='p-6'>
									<p
										className={`font-ui text-[9px] tracking-[3px] uppercase font-semibold mb-2 ${accent === 'crimson' ? 'text-crimson' : 'text-royal'}`}
									>
										{label}
									</p>
									...
									<div
										className={`flex items-center gap-1.5 font-ui text-[9px] tracking-[2px] uppercase font-semibold ${accent === 'crimson' ? 'text-crimson' : 'text-royal'}`}
									>
										<span>Explore</span>
										<ChevronRight
											size={13}
								...
								{/* Bottom accent line */}
								<div
									className={`absolute bottom-0 left-0 right-0 h-[2px] scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left ${accent === 'crimson' ? 'bg-crimson' : 'bg-royal'}`}
								/>
							</Link>
						),
					)}
