	...
	return (
		<section className='section-pad bg-cream'>
			<div className='container-main'>
				...
				{/* Featured video */}
				<div className='relative h-64 sm:h-80 md:h-[420px] rounded-3xl overflow-hidden mb-6 group cursor-pointer shadow-xl shadow-navy/20'>
					<Image
						src='/easter.jpg'
				...
				<div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-6'>
					{recent.map((s, i) => (
						<div
							key={i}
							className='group cursor-pointer rounded-2xl overflow-hidden bg-white border border-parchment/60 shadow-sm hover:shadow-xl hover:shadow-crimson/10 transition-all duration-300 hover:-translate-y-1'
						>
				...
				<div className='bg-royal rounded-3xl p-6 sm:p-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5 shadow-md shadow-royal/20'>
					...
					<a
						href='https://www.facebook.com/ststephenscathedralksm/about'
						target='_blank'
