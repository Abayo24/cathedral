...
export const SETTINGS: SiteSettings = {
	...
	plusCode: 'VQR3+QM3',
	mapQuery: "St. Stephen's Cathedral, VQR3+QM3, Got Huma Road, Kisumu, Kenya",
	// Plus Code VQR3+QM3 (full: 6GFPVQR3+QM3), supplied by the Cathedral.
	geo: { lat: -0.1081125, lng: 34.7541719 },
	social: {
